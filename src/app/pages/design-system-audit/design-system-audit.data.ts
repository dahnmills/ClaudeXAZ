...
export const DS_COMPONENTS: DsComponentEntry[] = [
  ...
  { name: 'Segmented Control', folder: 'segmented-control', category: 'Action', storybookTitle: 'Design System/Action/Segmented Control', hasAutodocs: true, usageCount: 1, usagePages: ['portfolio-management (via select-portfolio-modal)'], status: 'niche', note: "Corrected on 2026-09-10. The audit listed buyer-summary, which no longer holds one: the only consuming page is the scale switch of the portfolio picker." },
  ...
  { name: 'Radio Card', folder: 'radio-card', category: 'Data Entry', storybookTitle: 'Design System/Data Entry/Radio Card', hasAutodocs: true, usageCount: 3, usagePages: ['admin-data', 'tag-configuration (via rule-modal)', 'portfolio-management (via select-portfolio-modal)'], status: 'niche', note: 'Gained a third page on 2026-09-10: the portfolio picker lists its scopes as radio cards. A named "meta" slot was added on that occasion, for the figures facing the label.' },
