...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    changes: [
      ...
      'A phone search reads with its dialling code, "+33 612345678" and not "612345678". The search bar puts the code in front of the field and keeps it out of what you type, so the column had to put it back: a number without its code is nobody\'s number',
      ...
      'The screen breathes on a 24px side gutter instead of 32px, breadcrumb, tabs, search bar and cards on the same left edge. A row of eleven criteria needs the width more than the margin does',
      ...
      'Both tabs carry their count on the tab itself, and their "Clear all" sits alone above the list on the right, where the actions of a list belong on every other screen. No sentence repeating how many entries there are',
  ...
  },
  {
    ...
    changes: [
      ...
      'Both buttons of the title row read in the blue every other plain button uses, instead of the dark grey tone they had taken',
  ...
  },
  {
    ...
    changes: [
      ...
      'In the rule window, the hint under a field no longer pushes the row down when it appears. The freshness hint is written once and stays put, whether the field is available or not',
