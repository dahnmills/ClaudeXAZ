  ...
  return [
    {
      ...
      reaction: 'like', rating: 5, comment: "The risk grade is immediately visible, right where I'd look for it. Very clear.",
      target_mode: 'element', target_selector: 'section.ds-card > div.ds-grade', target_text: 'Grade A2 · Low risk', target_label: 'ds-grade ds-badge',
      target_rect: { x: 320, y: 180, w: 220, h: 64 }, screenshot: shot('Buyer summary · grade block', '#003781'),
    },
    {
      ...base, id: 's-2', created_at: hoursAgo(5), session_id: SESSION_A,
      route: '/review/buyer-summary/137381425', kind: 'comment',
      reaction: 'confused', rating: null, comment: 'I don\'t understand the difference between "exposure" and "outstanding". Two similar labels, no definition on hover.',
      target_mode: 'zone', target_selector: null, target_text: null, target_label: 'ds-properties-panel ds-card',
      target_rect: { x: 80, y: 420, w: 520, h: 180 }, screenshot: shot('Properties panel · exposure', '#496ebd'),
    },
    {
      ...
      target_mode: 'element', target_selector: 'ds-search-bar input', target_text: 'Search for a company', target_label: 'ds-search-bar',
      target_rect: { x: 240, y: 96, w: 640, h: 48 }, screenshot: shot('Search · bar', '#007ab3'),
    },
    {
      ...base, id: 's-4', created_at: hoursAgo(26), session_id: SESSION_B,
      route: '/review/tag-configuration', kind: 'comment',
      reaction: 'dislike', rating: 2, comment: "Reordering rules with the mouse is frustrating: the drop target isn't clear, I moved the wrong rule twice.",
      target_mode: 'zone', target_selector: null, target_text: null, target_label: 'ds-collapsible-table',
      target_rect: { x: 64, y: 260, w: 800, h: 320 }, screenshot: shot('TAG · reordering', '#b0050c'),
    },
    {
      ...
      target_mode: 'element', target_selector: 'ds-button.ds-button--type-primary', target_text: 'Save rules', target_label: 'ds-button',
    ...
    },
    {
      ...
      reaction: null, rating: null, comment: "There's no loading state: the table stays empty for a second, making it look like there's no data.",
    ...
    },
    {
      ...
      reaction: 'like', rating: null, comment: null,
      target_mode: 'element', target_selector: 'ds-timeline', target_text: 'Decision history', target_label: 'ds-timeline',
      target_rect: { x: 640, y: 420, w: 360, h: 300 }, screenshot: shot('Timeline · decisions', '#1e8927'),
    },
    {
      ...base, id: 's-8', created_at: hoursAgo(120), session_id: SESSION_B,
      route: '/review/search', kind: 'screen',
      reaction: 'confused', rating: 3, comment: 'The results screen is dense. Fine for an expert, but a "decision" filter at the top of the list would help sort quickly.',
